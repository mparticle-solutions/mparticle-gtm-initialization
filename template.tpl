...

{
  ...
  "description": "mParticle Web SDK Initialization Template",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "notSetText": "Required!",
    "help": "Please copy the Web API key from the mParticle Input configuration screen.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
...
(
            function (t) {
                //access and add to window.mParticle
                ...
                e.forEach(function (t) {
                    mParticleObject[t] = n(t);
                });
                o.forEach(function (t) {
                    mParticleObject.eCommerce[t] = n(t, "eCommerce");
                });
                i.forEach(function (t) {
                    mParticleObject.Identity[t] = n(t, "Identity");
                });
                function n(e, o) {
                    return function () {
                        if (o) {
                        ...
                        var t = callInWindow("Array.prototype.slice.call", arguments);
                        t.unshift(e);
                        mParticleObject.config.rq.push(t);
                    };
                }
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://jssdkcdns.mparticle.com/js/v2/*/mparticle.js"
              }
            ]
          }
        }
